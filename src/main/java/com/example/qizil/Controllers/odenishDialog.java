...
public class odenishDialog implements Initializable {
    ...
    public void insertPayment(Customer customer){
        try {
            ds.open();
            ds.insertPayment(customer.getName(), choicebox.getValue(), Double.parseDouble(gram.getText()));
            ds.close();
        }catch (Exception e){
